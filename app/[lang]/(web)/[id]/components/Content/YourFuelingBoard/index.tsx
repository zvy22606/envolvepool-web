...
const YourFuelingBoard: React.FC<YourFuelingBoardProp> = ({}) => {
  ...
  return (
    <div className="relative overflow-hidden p-[2px]">
      <p className="body-xl-bold text-[#0B0D41]">{t(titleTxtData[2])}</p>
      <p className="body-l my-[24px] text-[#0B0D41]">{statusRender()?.titleDesc}</p>
      <Info />
